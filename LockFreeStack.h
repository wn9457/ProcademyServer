...
public:
	...
	bool pop(T* pOutData)
	{
		volatile LONG64 lUseSize = InterlockedDecrement64(&this->_UseSize);

		if (lUseSize < 0)
		{
			volatile LONG64 lCurSize = InterlockedIncrement64(&this->_UseSize);
		...
		volatile LONG64 lUniqueCount = InterlockedIncrement64((LONG64*)&this->_UniqueCount);
		volatile TopNODE bTopNode;
